...
const Sider: FunctionComponent<SiderProps> = () => {
  ...
  return (
    <div
      ref={refDiv}
      className={`overflow-visible fixed left-0 top-0 bottom-0 w-[280px]  z-30  bg-[#001529] ${siderStatus === "idle"
        ? ""
        : siderStatus
          ? "animate-sidebarShow"
    ...
    >
      <div
        className={`absolute top-[50%] translate-y-[-50%] ${siderStatus ? "right-[-16px]" : "right-[-20px]"
          }   bg-[#6366f1] w-10 h-10 rounded-[56px] z-40 flex items-center  ${siderStatus ? "justify-center" : "justify-end"
